...
document.addEventListener('DOMContentLoaded', () => {
    ...
    langLinks.forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            const overlayShopLinks = document.querySelectorAll('.overlay-nav a[href*="shop"]');
    ...
    function applyLanguageChange(lang) {
        ...
        const headerShopLinks = document.querySelectorAll('header nav a[href*="shop"]');
    ...
    if (savedLang) {
        ...
        setTimeout(() => {
            if (window.languageSwitcher && window.languageSwitcher.getCurrentLang() !== savedLang) {
